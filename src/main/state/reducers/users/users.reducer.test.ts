...
describe('usersReducer', () => {
  ...
  describe('ALL_USERS actions', () => {
    it('should handle GET_ALL_USERS_STARTED', () => {
      ...
      expect(newState).toEqual({ ...initialUsersReducerState, loading: true, error: null })
    })
    ...
    it('should handle GET_ALL_USERS_SUCCESS', () => {
      ...
      expect(newState).toEqual({ ...initialUsersReducerState, users, loading: false, error: null })
    })
  ...
  describe('SINGLE_USER actions', () => {
    ...
    it('should handle GET_SINGLE_USER_SUCCESS', () => {
      ...
      expect(newState).toEqual({ ...initialUsersReducerState, user, loading: false, error: null })
    })
