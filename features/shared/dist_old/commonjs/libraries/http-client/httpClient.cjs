...
var HttpMethods = require('./constants/http-methods/HttpMethods.cjs');
...
var generateQueryParams = function generateQueryParams(queryParams) {
  return queryParams ? "?".concat(qs__namespace.stringify(queryParams)) : '';
};
...
var getDefaultHeaders = function getDefaultHeaders() {
  return {
    'Device-Id': "".concat(SecurityService.getBrowserSecurityService().getBrowserFingerprint()),
...
var buildAxiosConfig = function buildAxiosConfig(customHeaders) {
  ...
  if (useDefaultHeaders) {
    for (var _i = 0, _Object$entries = Object.entries(getDefaultHeaders()); _i < _Object$entries.length; _i++) {
      var _Object$entries$_i = slicedToArray.default(_Object$entries[_i], 2),
  ...
  if (customHeaders) {
    for (var _i2 = 0, _Object$entries2 = Object.entries(customHeaders); _i2 < _Object$entries2.length; _i2++) {
      var _Object$entries2$_i = slicedToArray.default(_Object$entries2[_i2], 2),
  ...
  if (useAuthorization) {
    var token = AuthenticationService.AuthenticationService.getAccessToken();
    if (token) {
...
function _request() {
  _request = asyncToGenerator.default(/*#__PURE__*/index.default.mark(function _callee(_ref) {
    ...
    return index.default.wrap(function (_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          axiosMethods = defineProperty.default(defineProperty.default(defineProperty.default(defineProperty.default(defineProperty.default({}, HttpMethods.HttpMethods.GET, function () {
            return axiosInstance.get(finalUrl, config);
          }), HttpMethods.HttpMethods.POST, function () {
            return axiosInstance.post(finalUrl, body, config);
          }), HttpMethods.HttpMethods.PUT, function () {
            return axiosInstance.put(finalUrl, body, config);
          }), HttpMethods.HttpMethods.PATCH, function () {
            return axiosInstance.patch(finalUrl, body, config);
          }), HttpMethods.HttpMethods.DELETE, function () {
...
var httpClient = {
  ...
  patch: function patch(params) {
    return request(_objectSpread(_objectSpread({}, params), {}, {
      method: HttpMethods.HttpMethods.PATCH
    }));
  },
  "delete": function _delete(params) {
    return request(_objectSpread(_objectSpread({}, params), {}, {
      method: HttpMethods.HttpMethods.DELETE
    }));
  }
};
