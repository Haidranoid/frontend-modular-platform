...
var createSliceTools = require('./create-slice-tools/createSliceTools.cjs');
...
function createSlice(options) {
  ...
  var _createSliceTools = createSliceTools.createSliceTools(options.api, options.sliceId),
  ...
  var slice = toolkit.createSlice({
    ...
    extraReducers: function extraReducers(builder) {
      ...
      builder.addMatcher(generateMatcher.generateMatcher(SliceNames.SliceNames.Global, MatcherIdentifiers.MatcherIdentifiers.IS_FULFILLED), function () {
